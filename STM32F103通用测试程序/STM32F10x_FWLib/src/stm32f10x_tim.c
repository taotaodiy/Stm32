...
/**
  ...
  * @param  外设TIMx的新状态 ENABLE or DISABLE.
  * @retval None
  */
...
/**
  * @brief  使能或者失能指定的TIM中断.
  * @param  TIMx: x可以是1-17，来选择TIM外设.
  * @param  TIM_IT: 待使能或者失能的TIM中断源.
  ...
  * @param  NewState: TIMx中断的新状态 ENABLE or DISABLE.
  * @retval None
  */
...
/**
  * @brief  检查指定的TIM中断发生与否.
  * @param  TIMx: x可以是 1-17 来选择TIM外设.
  * @param  TIM_IT: 待检查的TIM中断源.
  *   This parameter can be one of the following values:
  *     @arg TIM_IT_Update: TIM update Interrupt source
  *     @arg TIM_IT_CC1: TIM Capture Compare 1 Interrupt source
  *     @arg TIM_IT_CC2: TIM Capture Compare 2 Interrupt source
  ...
  *   - TIM_IT_Break is used only with TIM1, TIM8 and TIM15. 
  *   - TIM_IT_COM is used only with TIM1, TIM8, TIM15, TIM16 and TIM17.  
  * @retval TIM_IT的新状态 SET or RESET.
  */
