...
typedef struct
{
  uint16_t TIM_Prescaler;         /*!< 时钟预分频数 0x0000-0xFFFF */
  uint16_t TIM_CounterMode;       /*!< 计数器模式 @ref TIM_Counter_Mode */
  uint16_t TIM_Period;            /*!< 自动重装值 0x0000-0xFFFF  */ 
  uint16_t TIM_ClockDivision;     /*!< 设置了时钟分割 @ref TIM_Clock_Division_CKD */
...
typedef struct
{
  ...
  uint16_t TIM_OCPolarity;    /*!< 输出极性 @ref TIM_Output_Compare_Polarity */
