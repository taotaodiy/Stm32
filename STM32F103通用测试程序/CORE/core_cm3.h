...
typedef struct
{
  __IO uint32_t CTRL;                         /*!< Offset: 0x00  控制和状态寄存器 */
  __IO uint32_t LOAD;                         /*!< Offset: 0x04  重装载值寄存器       */
  __IO uint32_t VAL;                          /*!< Offset: 0x08  当前值寄存器      */
  __I  uint32_t CALIB;                        /*!< Offset: 0x0C  校准值寄存器        */
} SysTick_Type;
